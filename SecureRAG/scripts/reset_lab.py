...
def main() -> int:
    ...
    # Defaulted to "vulnerable" as a fork leftover. In this repository that profile does not exist,
    # so a plain `reset_lab.py` failed in load_settings() instead of resetting the secure lab.
    parser.add_argument("--profile", default="secure")
